...
var (
	...
	ErrSwarmUnsupportedOnPodman                = Classify(ErrBadRequest, errors.Sentinel("Swarm is not supported on Podman; use Kubernetes (podman kube play) instead"))
	ErrBuildUnsupportedOnPodman                = Classify(ErrBadRequest, errors.Sentinel("image builds require Docker BuildKit and are not supported on Podman"))
	ErrPatchUnsupportedOnPodman                = Classify(ErrBadRequest, errors.Sentinel("image patching (Copacetic) requires Docker BuildKit and is not supported on Podman"))
